...
*************************************************************************
       subroutine change_params(nlsegs,lsegs,module,clu,lscen,paramscen,
...
********* adjust KIMNI and KIMAM based on uptake
        if (taruptk(ns).gt.0.01 .and. simuptk. ne. -1.0) then    ! adjust only segments woth Nonzero uptake
          do nly = 1, 3
