...
*************************************************************************
       subroutine change_params(nlsegs,lsegs,module,clu,paramscen,
     I                          version,targets,simEOF,
...
************ re-arrange target and simulated loads to make codes more readable
        ...
        SN(ns)   = simEOF(16,ns)                            ! Total Storage of Nitrogen in PLS

********** adjust Params for surface 
        do nly = 1, 2
          KIMAM(nly)=KIMAM(nly)*(SNH4(ns)+SNO3(ns))
