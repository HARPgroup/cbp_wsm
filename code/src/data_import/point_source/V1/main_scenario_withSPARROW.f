...
************ Apply CSO Pass Thru #1
        Tflow = Tflow * CSOPassThru(cbcsoid,1)
        Tbod  = Tbod  * CSOPassThru(cbcsoid,1)
        Tdox  = Tdox  * CSOPassThru(cbcsoid,1)
        Tnh3  = Tnh3  * CSOPassThru(cbcsoid,1)
        Tno3  = Tno3  * CSOPassThru(cbcsoid,1)
        Torn  = Torn  * CSOPassThru(cbcsoid,1)
        Tpo4  = Tpo4  * CSOPassThru(cbcsoid,1)
        Torp  = Torp  * CSOPassThru(cbcsoid,1)
        Ttss  = Ttss  * CSOPassThru(cbcsoid,1)

************ Apply CSO Pass Thru #2 or Holding Threshold
        if ( CSOPassThru(cbcsoid,3) .gt. 0 ) then
          if ( Tflow .lt. CSOPassThru(cbcsoid,3) ) then
            F_holdfac = 0.0
          else
            F_holdfac = (Tflow - CSOPassThru(cbcsoid,3)) / Tflow
          end if
          Tflow = Tflow * F_holdfac
          Tbod  = Tbod  * F_holdfac
          Tdox  = Tdox  * F_holdfac
          Tnh3  = Tnh3  * F_holdfac
          Tno3  = Tno3  * F_holdfac
          ...
          Torp  = Torp  * F_holdfac
          Ttss  = Ttss  * F_holdfac
        else if ( CSOPassThru(cbcsoid,3) .eq. -9 ) then
          Tflow = Tflow * CSOPassThru(cbcsoid,2)
          Tbod  = Tbod  * CSOPassThru(cbcsoid,2)
          Tdox  = Tdox  * CSOPassThru(cbcsoid,2)
          Tnh3  = Tnh3  * CSOPassThru(cbcsoid,2)
          Tno3  = Tno3  * CSOPassThru(cbcsoid,2)
          Torn  = Torn  * CSOPassThru(cbcsoid,2)
          Tpo4  = Tpo4  * CSOPassThru(cbcsoid,2)
          Torp  = Torp  * CSOPassThru(cbcsoid,2)
          Ttss  = Ttss  * CSOPassThru(cbcsoid,2)
        end if
