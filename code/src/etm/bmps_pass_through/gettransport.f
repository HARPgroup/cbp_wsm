...
************************************************************************
     ...
     O                        trandata)
      ...
      character(1200):: dline !BHATT 900 to 1200
...
**************END DECLARATION ******************************************
      ...
      read(dfile,'(a1200)',err=996)dline            ! read header line !BHATT 900 to 1200
      call d2x(dline,i)
      if (dline(1200-3:1200).ne.'    ') go to 988 !BHATT 900 to 1200
      ...
      do while (ifound.lt.numsegs)  ! file until all land segs are found
        read(dfile,'(a1200)',err=997,end=998)dline !BHATT 900 to 1200
        call d2x(dline,last)
        if (dline(1200-5:1200).ne.'      ') go to 990 !BHATT 900 to 1200
