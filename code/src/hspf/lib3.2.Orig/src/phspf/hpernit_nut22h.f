...
c           NICONC = (  SMST  /(fldcp))*NO3/MOISTM*1.0E6 
...
c !                             or  0.1??? 
                 AMCONC =AMSU/MOISTM*1.0E6
c           AMCONC = (  SMST  /(fldcp))*AMSU/MOISTM*1.0E6 
...
c     write(98,*) SMST, pwsoildd, wiltpt, fldcp, utni, utam
        END IF
      write(98,431)SMST,pwsoildd,wiltpt,fldcp,utni,utam,niconc,amconc
      END IF
C
