...
!            goto 221
         if(cno3w .gt. cno3s) then
          dnit1 = dvvt * (cno3w-cno3s)/fctdv2  ! diffus rate:water 2 soil
          dnit1 = dnit1*bedarea*porop       ! * area * time = distance or mass into
         else            ! kg / time step ->      
          dnit1 = 0.
         endif
          dnit1  = min(wtno3w*0.95, dnit1)
!        dw2s = 0.000000000
!         wtno3w = wtno3w - dnit1
!         ddnit = umaxt* cno3s / (cno3s + dnt50)  !kg/m2/depth
!         ddnit = ddnit * bedarea * porop * zdpth
!         ddnit = min(wtno3s*0.95, ddnit)  
!        ddnit = 0.000000000
!         wtno3s = wtno3s + dnit1 - ddnit   ! update kg? 
!         cno3s  = wtno3s * 1000. / (bedarea*porop*zdpth) ! update, g/m3 = mg/l
!         cno3s  = wtno3s *1.    / vsoilw                ! update, g/m3 = mg/l
!         NO3 = wtno3w / (VOLtt     *0.0283168)  ! not times 43560. )
!         NO3 = wtno3w / ((VOL/delt60)*43560.*0.0283168)  ! not times 43560. )
!         ddnit = (ddnit + dnit1)        * 2.2045 !      kg -> pound  
          ddnit = (        dnit1)        * 2.2045 !      kg -> pound  
221      continue 
         goto 222
