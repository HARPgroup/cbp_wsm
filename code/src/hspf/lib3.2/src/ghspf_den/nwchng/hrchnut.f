...
!pw   write(*,*)'bdenit 1: ,umaxhr,zdpth,Tzden,vol,volsp,vwater,no3,d50'
! pw  write(*,*)'bdenit1:',umaxhr,zdpth,Tzden,vol,volsp,vwater,no3,dnt50
!     write(*,*)'bdenit2:,dvvhr,ength,bedwidd,bedarea,cwwi,cssi,css,wtw'
...
C     + + + END SPECIFICATIONS + + +
C
! pw  write(*,*)'denit 1:','umaxhr,zdpth,Tzden,vol,volsp,vwater,no3,d50'
!     write(*,*)'denit1:',umaxhr,zdpth,Tzden,vol,volsp,vwater,no3,dnt50
!     write(*,*)'denit2: ,dvvhr,ength,bedwidd,bedarea,cwwi,cssi,css,wtw'
...
!!! note fctdv2 = 1/zdpth, 
        ddnit = 0.0
          ...
          umaxt =  umaxt*(TzDEN**(TW-20.))  ! red fro segment info
...
!         cno3s  = wtno3s * 1000. / (bedarea*porop*zdpth) ! update, g/m3 = mg/l
          cno3s  = wtno3s * 1000. / vsoilw                ! update, g/m3 = mg/l
          NO3 = wtno3w / VOLtt
