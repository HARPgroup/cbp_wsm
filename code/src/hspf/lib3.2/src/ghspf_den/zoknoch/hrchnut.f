...
C         consider denitrification processes, and compute associated fluxes
      write(*,*)'bdenit 1: ,umaxhr,zdpth,Tzden,vol,volsp,vwater,no3,d50'
      write(*,*)'bdenit1:',umaxhr,zdpth,Tzden,vol,volsp,vwater,no3,dnt50
...
C     + + + END SPECIFICATIONS + + +
C
!        write(*,*)'denit: 1:', cssss, zdpth, dvvhr
      write(*,*)'denit 1:','umaxhr,zdpth,Tzden,vol,volsp,vwater,no3,d50'
      write(*,*)'denit1:',umaxhr,zdpth,Tzden,vol,volsp,vwater,no3,dnt50
      write(*,*)'denit2: ,dvvhr,ength,bedwidd,bedarea,cwwi,cssi,css'
      write(*,*)'denit2:',dvvhr,ength,bedwidd,bedarea,cwwi,cssi,css
!     write(*,*) 'nut  2:','bedarea, bedwidd, ength,delta60'    
!     write(*,*) 'nut  2:', bedarea, bedwidd, ength,delta60     
!     write(*,*) 'nut  2:','DNUST(1), DNUST2(1), cwwi, wtno3wi'
!     write(*,*) 'nut  2:',                      cwwi, wtno3wi 
!        pause 
