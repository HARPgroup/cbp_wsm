...
c        pwwiltpt = pwwiltpt * pwsoild ! wiltpt from in/in as (in) spec soil
           wiltpt(jw) =   wiltpt(jw) * pwsoild(jw) 
           fieldcp(jw) = -9.033*wiltpt(jw)*wiltpt(jw)+3.7062*wiltpt(jw)
     /                   + 0.0027     ! fieldcp also for spec soil depth 
         enddo  
c! pw  end pw added
...
c! pw out   NICONC= NO3/MOISTM*1.0E6
