...
************************************************************************
      ...
      character*(*) line
      integer uci
      line = '  UVNAME  MNO3    2 SNO3              0.5 QUAN    '//
     .                           'UNO3              0.5 QUAN'
      call ryt(line,uci)
      line = '  UVNAME  MNH3    2 SAMAD             0.5 QUAN    '//
     .                           'UAMAD             0.5 QUAN'
      call ryt(line,uci)
      line = '  UVNAME  MORN    2 SORGN             0.5 QUAN    '//
     .                           'UORGN             0.5 QUAN'
      call ryt(line,uci)
      line = '  UVNAME  MPO4    2 SP4AD             0.5 QUAN    '//
     .                           'UP4AD             0.5 QUAN'
      call ryt(line,uci)
      line = '  UVNAME  MORP    2 SORGP             0.5 QUAN    '//
     .                           'UORGP             0.5 QUAN'
      call ryt(line,uci)
      return
      end
