...
***** WRITE SPECIAL ACTION for varied land cover IN UCI FILE
      ...
      write(line(14:19),'(F6.3)') precip
      if (writeact) call ryt(line,uci)
      line = '  PERLND  1                            3 '//
     .       ' ??????          = <<<value>> '

      write(line(43:48),'(A6)')'INFEXP'
      write(line(61:70),'(F10.7)')infexp
      if (writeact) call ryt(line,uci)

c      write(line(43:48),'(A6)')'INFILT'
c      write(line(61:70),*)fPar(3,2,3)/10
...
c      write(line(43:48),'(A6)')'LZSN  '
c      write(line(61:70),*)fPar(3,2,2)*0.25
c      if (writeact) call ryt(line,uci)
...
c      write(line(61:70),*)infexp
      write(line(61:70),'(F10.7)')fPar(3,3,3)
      if (writeact) call ryt(line,uci)

c      write(line(43:48),'(A6)')'INFILT'
c      write(line(61:70),*)fPar(3,2,3)
c      if (writeact) call ryt(line,uci)
