...
if ~strcmpi(comp_type(1:3),'PCW'), % not a PC Windows machine - use MAC path style.
    ...
    handles.connect_path = ['/Volumes/model/',handles.BaseDir,'/pp/catalog/connect/']; % search path for connect files.
    ...
    handles.connect_path = [handles.DriveLetter,':\',handles.BaseDir,'\pp\catalog\connect\']; % search path for connect files.
...
if ~strcmpi(comp_type(1:3),'PCW'), % not a PC Windows machine - use MAC path style.
    ...
    connect_path = ['/Volumes/model/',folder,'/pp/catalog/connect/']; % search path for connect files.
