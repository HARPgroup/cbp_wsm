...
if ~strcmpi(comp_type(1:3),'PCW'), % not a PC Windows machine - use MAC path style.
    handles.river_sim_path = ['/Volumes/model/',handles.BaseDir,'/output/river/daily/']; % search path for river simulated data.
    handles.land_sim_path = ['/Volumes/model/',handles.BaseDir,'/output/pltgen/land/']; % search path for land simulated data.
    % handles.obs_path = ['/Volumes/model/p5_observed/']; % search path for observed data.
    % handles.obs_path = ['/Volumes/model/',folder,'/pp/observed/'] % search path for observed data.
    handles.obs_path = ['/Volumes/model/',handles.BaseDir,'/pp/observed/',data_scen,'/']; % search path for observed data.
    handles.connect_path = ['/Volumes/model/',handles.BaseDir,'/pp/catalog/geo/']; % search path for connect files.
    handles.batch_path = ['/Volumes/model/',handles.BaseDir,'/run/seglists/']; % search path for ".calib" file for batch processing.
    handles.win_path = ['/Volumes/model/',handles.BaseDirr,'/output/river/window/']; % search path for windowed data file.
    ...
    handles.obs_path = [handles.DriveLetter,':\',handles.BaseDir,'\pp\observed\',handles.ObScen,'\']; % search path for observed data.
    handles.connect_path = [handles.DriveLetter,':\',handles.BaseDir,'\pp\catalog\geo\']; % search path for connect files.
    handles.batch_path = [handles.DriveLetter,':\',handles.BaseDir,'\run\seglists\']; % search path for ".calib" file for batch processing.
...
% build search paths...
if ~strcmpi(comp_type(1:3),'PCW'), % not a PC Windows machine - use MAC path style.
    river_sim_path = ['/Volumes/model/',folder,'/output/river/daily/']; % search path for river simulated data.
    land_sim_path = ['/Volumes/model/',folder,'/output/pltgen/land/']; % search path for land simulated data.
    % obs_path = ['/Volumes/model/p5_observed/']; % search path for observed data.
    % obs_path = ['/Volumes/model/',folder,'/pp/observed/'] % search path for observed data.
    obs_path = ['/Volumes/model/',folder,'/pp/observed/',data_scen,'/']; % search path for observed data.
    connect_path = ['/Volumes/model/',folder,'/pp/catalog/geo/']; % search path for connect files.
    batch_path = ['/Volumes/model/',folder,'/run/seglists/']; % search path for ".calib" file for batch processing.
    win_path = ['/Volumes/model/',folder,'/output/river/window/']; % search path for windowed data file.
else % assume PC Windows machine - use ordinary path style.
    ...
    obs_path = [drive,':\',folder,'\pp\observed\',data_scen,'\']; % search path for observed data.
    connect_path = [drive,':\',folder,'\pp\catalog\geo\']; % search path for connect files.
