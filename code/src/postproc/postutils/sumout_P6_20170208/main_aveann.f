...
********** indices and accounting variables
      ...
      character*3 EOP,EOF,EOS,EOR,DEL
      data EOP,EOF,EOS,EOR,DEL /'eop','eof','eos','eor','del'/

      integer year1,year2
      character*4 cy1,cy2

      integer iEOF,iEOS,iDEL  ! input flags 
      logical doEOP,doEOF,doEOS,doEOR,doDEL  ! logical values
