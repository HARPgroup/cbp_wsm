...
set FACTORSTP  = ( 0.8951        1.1620        1.3046        1.2786        0.9579        0.8592        0.8847        0.8847        1.0802        0.7572 )
...
cd $SCRIPT_DIR
csh bhatt_run_river_oneseg_calib.csh $SCENARIO JL7_7030_6800 $TMPDIR & wait
csh bhatt_run_river_oneseg_calib.csh $SCENARIO JL7_6800_7070 $TMPDIR & wait
csh bhatt_run_river_oneseg_calib.csh $SCENARIO JL7_7070_0001 $TMPDIR & wait
csh bhatt_run_river_oneseg_calib.csh $SCENARIO YP4_6750_0001 $TMPDIR & wait
csh bhatt_run_river_oneseg_calib.csh $SCENARIO YM4_6620_0001 $TMPDIR & wait
