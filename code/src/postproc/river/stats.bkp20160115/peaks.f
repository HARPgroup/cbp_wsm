...
cbhatt      print*,(obs(npmatch),npmatch=1,ndays)
cbhatt      print*,(sim(npmatch),npmatch=1,ndays)
cbhatt      print*,(obspeak(npmatch),npmatch=1,npobs)
cbhatt      print*,(obspeakday(npmatch),npmatch=1,npobs)
cbhatt      print*,(simpeak(npmatch),npmatch=1,npsim)
cbhatt      print*,(simpeakday(npmatch),npmatch=1,npsim)
