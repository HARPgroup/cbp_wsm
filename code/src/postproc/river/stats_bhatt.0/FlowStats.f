...
************************************************************************
      subroutine FlowStats(rscen,rseg,year1,year2,wdmfil,
     .                  Nexits,postfix)
...
******************* END DECLARATIONS ***********************************
     ...
     I       sdate,postfix(:lenpostfix))

********************Calculate statistics for flow
c bhatt      call doflows(
c bhatt     I             rscen,obscen,rseg,year1,year2,nvals,flowvals,
c bhatt     I             sdate,npeaks,
c bhatt     O             simfl,obfl,bofl,bsfl,qofl,qsfl,FloObsExist)

******* Calculate stats for concs and instantaneous loads
************   in rchres_out_to_conc vs observed
c bhatt      call doconcs(
c bhatt     I             rscen,obscen,rseg,year1,year2,window,
c bhatt     I             nRvar,Rdsn,Rname,wdmfil,sdate,edate,
c bhatt     I             simfl,obfl,bofl,bsfl,qofl,qsfl,FloObsExist)

******* Calculate statistics for loads in rchres_out_to_load
*********** vs ESTIMATOR loads
c bhatt      call doloads(
c bhatt     I             rscen,rseg,year1,year2,
c bhatt     I             nRvar,Rdsn,Rname,wdmfil,sdate,edate)
