...
********* loop over species, create temporary monthly variable
      do sp = 1,nspecies
        ...
        print*,'nB, nB2 a= ',nB ,nB2

        call rmMissingMonthly(maxTimeBreaks,lseg,clu,year1,year2,
     M                        nB2,Jday2,Byear2,Bmonth2,Bday2,monthly) !GY

        print*,'nB, nB2 b= ',nB ,nB2

        if (nB2.gt.0) then  ! if all missing, then don't do this species !GY
