...
************************************************************************
     ...
     I                      startY,startM,startD,endY,endM,endD)
      ...
      double precision monapp(startY:endY,12,nspecies) ! monthly application GY
...
*************** read each type from wdm and store in variable
     ...
     O                 ndays,dval)
      ...
      do nd = 1,ndays
        ...
        monapp(year,month,spno3) = monapp(year,month,spno3) + dval(nd) !GY
     ...
     O                 ndays,dval)
      ...
      do nd = 1,ndays
        ...
        monapp(year,month,spnh3) = monapp(year,month,spnh3) + dval(nd) !GY
        call tomorrow(year,month,day)
      end do
