...
************************************************************************
     ...
     .       //'   0    0    0    0   12'
      do nm = 1,nmod
        if (modules(nm).eq.'ATEMP')  line(15:15) = '5'
        if (modules(nm).eq.'SNOW')   line(20:20) = '5'
        if (modules(nm).eq.'PWATER') line(25:25) = '5'
        if (modules(nm).eq.'SEDMNT') line(30:30) = '5'
        if (modules(nm).eq.'PSTEMP') line(35:35) = '5'
        if (modules(nm).eq.'PWTGAS') line(40:40) = '5'
        if (modules(nm).eq.'PQUAL')  line(45:45) = '5'
        if (modules(nm).eq.'MSTLAY') line(50:50) = '5'
        if (modules(nm).eq.'PEST')   line(55:55) = '5'
        if (modules(nm).eq.'NITR')   line(60:60) = '5'
        if (modules(nm).eq.'PHOS')   line(65:65) = '5'
        if (modules(nm).eq.'TRACER') line(70:70) = '5'
      end do
      call ryt(line,uci)
...
************************************************************************
      ...
      do nm = 1,nmod
        if (modules(nm).eq.'ATEMP')  line(15:15) = '5'
        if (modules(nm).eq.'SNOW')   line(20:20) = '5'
        if (modules(nm).eq.'IWATER') line(25:25) = '5'
        if (modules(nm).eq.'SOLIDS') line(30:30) = '5'
        if (modules(nm).eq.'IWTGAS') line(35:35) = '5'
        if (modules(nm).eq.'IQUAL')  line(40:40) = '5'
      end do
      call ryt(line,uci)
