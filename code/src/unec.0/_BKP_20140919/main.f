...
C SET 2
      I_sParamLeadEdge    = 3
      I_sParamPeakConc    = 6
      I_sParamTrailEdge   = 18
      D_sParamExponent1   = 0.1D0
      D_sParamExponent2   = 0.2D0
      I_sParamNormalize   = 1
      
      I_dParamLeadEdge    = 3
      I_dParamPeakConc    = 6
      I_dParamTrailEdge   = 18
      D_dParamExponent1   = 0.1D0
      D_dParamExponent2   = 0.2D0
      I_dParamNormalize   = 1
      ...
      I_iParamLeadEdge    = 3
      I_iParamPeakConc    = 6
      I_iParamTrailEdge   = 18
      D_iParamExponent1   = 0.1D0
      D_iParamExponent2   = 0.2D0
      I_iParamNormalize   = 1
