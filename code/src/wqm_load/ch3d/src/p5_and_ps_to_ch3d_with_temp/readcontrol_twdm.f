...
************************************************************************
     ...
     O                           doatdep,dops,dosep)
      ...
      print*,'readcontrol_wdm.f start'
C BHATT      fnam = tree//'run/control/river/'//rscen(:lenrscen)//'.con'
      fnam = tree//'config/control/river/'//rscen(:lenrscen)//
     . '.con'
      print*,'0 ',fnam
