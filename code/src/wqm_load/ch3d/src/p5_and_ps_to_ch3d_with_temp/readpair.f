...
************************************************************************
     ...
     O              pairq,pairH)  ! get the data
      ...
      integer year1,month1,day1,year2,month2,day2 ! requested period
      character*13 trseg
      character*6 tlseg
...
************* test data
      jday = julian(etmENDy,etmENDm,etmENDd,year2,month2,day2)
      if (jday.gt.1) go to 9951
      jday = julian(etmSRTy,etmSRTm,etmSRTd,year1,month1,day1)
...
9952  report(1) = 'problem with etm file: start date too late'
      ...
      write(report(3),*) 'req date: ',year1,',',month1,',',day1
      go to 999
