      ...
      do 
        read(11,*,end=111,err=111) lseg1,lu1,con1,value1
        read(12,*) lseg2,lu2,con2,value2
     ...
     .      con1.ne.con2   ) then
          ...
          if (value1.lt.-8) then
            ...
            if (value2.lt.-8) then
              ...
              outval = interpolate(ro,ry1,value1,ry2,value2)
              outval = max(outval,0.0)
            end if
          end if

        write(14,1234) lseg1,lu1,con1,outval
