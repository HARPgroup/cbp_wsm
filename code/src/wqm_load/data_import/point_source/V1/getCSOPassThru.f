      ...
      character*13  tlrseg
      character*25  tnpdes
      real    tpassthru1,tpassthru2,tholdthresh
      real    tfactors(SCBCSOID:ECBCSOID,3)
     ...
     .      tcbcsoid,tlrseg,tnpdes,tpassthru1,tpassthru2,tholdthresh
        tfactors(tcbcsoid,1) = tpassthru1
        tfactors(tcbcsoid,2) = tpassthru2
        tfactors(tcbcsoid,3) = tholdthresh
