...
************************************************************************
      subroutine ibubble(x,values,maxvals)
      implicit none
      integer values,maxvals
      integer x(maxvals),temp
...
C        if (mod(i,1000).eq.0) print*,'sorted ',i
      end do
      end

************************************************************************
**     real bubble sort -- slow but simple                            **
************************************************************************
      subroutine rbubble(x,values,maxvals)
      implicit none
      integer values,maxvals
      real x(maxvals),temp
...
************************************************************************
**     real 2 vector bubble sort, sorts on first vector               **
************************************************************************
      subroutine rbubble2vector(x,y,values,maxvals)
      implicit none
      integer values,maxvals
      real x(maxvals),y(maxvals),temp
      ...
      do i = 1,values
        ...
        if (mod(i,1000).eq.0) print*,'sorted ',i
      end do
      end

************************************************************************
**  integer/real 2 vector bubble sort, sorts on integer               **
************************************************************************
      subroutine irbubble2vector(k,y,values,maxvals)
      implicit none
      integer values,maxvals
      integer k(maxvals),ktemp
      real y(maxvals),ytemp
...
************************************************************************
**     double precision bubble sort -- slow but simple                **
************************************************************************
      subroutine dbubble(x,values)
      implicit none
      integer values
      double precision x(values),temp
...
************************************************************************
**     double precision 2 vector bubble sort, sorts on first vector   **
************************************************************************
      subroutine dbubble2vector(x,y,values)
      implicit none
      integer values
      double precision x(values),y(values),temp
