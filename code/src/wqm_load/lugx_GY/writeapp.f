...
c      write(11,'(A)',err=951) 'year,mm,',species(1),
c     .                    (',',species(sp),sp=2,nspecies)
      write(11,*,err=951) 'year,month',(',',species(sp),sp=1,nspecies)
      do year = year1,year2
        do month = 1,12
          write(11,1235,err=951) year,month,
     .               (monapp(year,month,sp),sp=1,nspecies)
        end do
      end do
