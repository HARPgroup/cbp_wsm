...
********** write out DAILY DATA
     ...
     .     '/'//rscen(:lenrscen)//'/'//fnam
        ...
        fnam = 'wsm57k_wsm_nps.YY_DT'           ! open file
        write(fnam(14:17),'(i4)') ny         
        fnam(14:15) = 's.'
        fnam = outdir//'wqm_input/'//Request(:lenRequest)//
     .     '/'//rscen(:lenrscen)//'/'//fnam
...
c        write(dfile,1233)
c     .     'CB Segment ','year','mnth','day',(Bname(nq),nq=1,nBvar)
        write(dfile+1,1233)
     .     'CB Segment ','year','mnth','day',(Bname(nq),nq=1,nBvar)
...
********** write out MONTHLY DATA
      do ny = year1,year2
        ...
        fnam = 'wsm57k_wsm_nps.YY_MC'           ! open file
        write(fnam(14:17),'(i4)') ny
        fnam(14:15) = 's.'
        fnam = outdir//'wqm_input/'//Request(:lenRequest)//
     .     '/'//rscen(:lenrscen)//'/'//fnam
        ...
        fnam = 'wsm57k_wsm_nps.YY_MT'           ! open file
        write(fnam(14:17),'(i4)') ny
        fnam(14:15) = 's.'
        fnam = outdir//'wqm_input/'//Request(:lenRequest)//
     .     '/'//rscen(:lenrscen)//'/'//fnam
...
********** write out ANNUAL DATA
      do ny = year1,year2
        ...
        fnam = 'wsm57k_wsm_nps.YY_YC'           ! open file
        write(fnam(14:17),'(i4)') ny
        fnam(14:15) = 's.'
        fnam = outdir//'wqm_input/'//Request(:lenRequest)//
     .     '/'//rscen(:lenrscen)//'/'//fnam
        ...
        fnam = 'wsm57k_wsm_nps.YY_YT'           ! open file
        write(fnam(14:17),'(i4)') ny
        fnam(14:15) = 's.'
        fnam = outdir//'wqm_input/'//Request(:lenRequest)//
     .     '/'//rscen(:lenrscen)//'/'//fnam
...
CXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
      ...
      stop
1234  format(A11,3(',',i4),18(',',e10.4))
1233  format(A11,3(',',A4),18(',',A10))
