...
********** ps, atdep, septic variables
      ...
      character*11 rpa,rib
      data rpa,rib /'rpaload','rib'/
      logical dorpa,dorib
...
CXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
      ...
      stop
1234  format(A,3(',',i4),18(',',e10.4))
1233  format(A,3(',',A4),18(',',A10))
