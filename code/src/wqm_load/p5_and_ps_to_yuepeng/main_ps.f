...
********** write out subset
      do ny = year1,year2
        ...
        fnam = 'wsm_ps.YY'           ! open file
        write(fnam(6:9),'(i4)') ny
        fnam(6:7) = 's.'
...
996   report(1) = 'point source method should be lrseg unless there '
      report(2) = ' is a specific wdm dataset developed for this run'
      report(3) = 'Try Again'
      go to 999
