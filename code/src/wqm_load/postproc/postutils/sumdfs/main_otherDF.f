...
********* variable for specifying delivery factor scenario
      character*40 DFscen
      integer lenDFscen

********************* END DECLARATIONS *********************************

      read*, rscen,DFscen,basin,year1,year2
...
*********** open delivery factor summary file
      fnam = sumoutdir//'aveann/'//rscen(:lenrscen)//'_DF_'//
     .     DFscen(:lenDFscen)//'/'//
     .     basin(:lenbasin)//'_'//cy1//'_'//cy2//'_'//
     .     rscen(:lenrscen)//'_DF_'//
     .     DFscen(:lenDFscen)//'_dfs.csv'
...
************** read from each output file 
     ...
     O                  numsegs,l2r)
        do ns = 1,numsegs
          fnam = outdir//'del/dfs/aveann/'//DFscen(:lenDFscen)//'/'//
     .           l2r(ns)//'_'//rseg//'_'//DFscen(:lenDFscen)//'_'//
     .           cy1//'_'//cy2//'.txt'
