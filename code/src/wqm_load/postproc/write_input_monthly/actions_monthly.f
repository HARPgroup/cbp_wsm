...
c        call writeapp(lscen,lenlscen,lseg,clu,species,nspecies,
c     I                year1,year2,apptype,annapp)
        return
      end if
...
************************************************************************
     ...
     .                   modules,nmod,species,nspecies)
      ...
      double precision annapp(year1:year2,nspecies) !annual application
      double precision monapp(year1:year2,12,nspecies) ! monthly application GY
      character*6 apptype
      data apptype /'manure'/
...
***** READ CONTROL FILE AND DATA
     ...
     M                          nB,Jday,Byear,Bmonth,Bday,manure)
      ...
      if (nB.lt.2) then  ! if still no data, write out zeros
        call writeapp_monthly(lscen,lenlscen,lseg,clu,species,nspecies,
