...
c            end do
     ...
     .               ( 1+(D_tSFLO*0.057)/(D_tSEDM*0.168) ) )
            ...
            if (L_REDO_NO3_FLOW .and. quals(k).eq.'NO3') then
               D_TargetS = D_TargetT * D_tSURO / (D_tSFLO + D_tAGWO)
               D_TargetI = D_TargetT * D_tIFWO / (D_tSFLO + D_tAGWO)
               D_TargetA = D_TargetT * D_tAGWO / (D_tSFLO + D_tAGWO)
            end if
