...
************************************************************************
     ...
     O                nBvar,Bname,Uname,nRv2Bv,Rname2Bv,Rfactor,DivBvar)
      ...
      character*4 nameR,nameB,nameU,Bdiv        ! temp variables 
      real factor
...
******* populate nBvar,Bname,nRv2Bv,Rname2Bv,Rfactor from 'river_to_bay'
      call lencl(rbfnam,last)
      fnam = catdir//'iovars/'//ioscen(:lenioscen)//'/'//rbfnam(:last)
      ...
      do while (line(:3).ne.'end')
        read(line,1234,iostat=err)nameB,nameU,nameR,factor,Bdiv
...
1234  format(a4,5x,a4,5x,a4,11x,f10.0,2x,a4)
