...
********** NPDES number, CSO BMP fatcors
      ...
      parameter (maxfacs = 4000)
      character*10 facility(maxfacs)
      real CSOfac(maxfacs),Tfactor
       
**************** END DECLARATIONS **************************************

******** get input data
      read*, year,psscen,dataversion,WWTPfnam,INDfnam,CSOfnam
...
998   write(report(1),*) 'facility ',Tfac
      report(2) = ' were found in the data file, but not in the'
      report(3) = ' CSO BMP factor file'
      go to 999
