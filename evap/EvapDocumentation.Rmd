...
library(raster)
```
The next lines produce a vector of numeric monthly abbreviations used by PRISM and accesses a pre-downloaded geodatabase containing a polygon feature class of the state boundary and a bounding box for the analysis. This box was created prior to the analysis in ArcGIS. The bounding box was projected into EPSG 4326, as already used by the state boundary. 
```{r,include=FALSE}
m<-c('01','02','03','04','05','06','07','08','09','10','11','12')
VA<-readOGR('C:\\Users\\connorb5\\Desktop\\GIS\\Post Summer\\PostSummer.gdb',layer="VA")
BB<-readOGR('C:\\Users\\connorb5\\Desktop\\GIS\\Post Summer\\PostSummer.gdb',layer="BoundingBox")
...
```{r,eval=FALSE}
setwd('C:/Users/connorb5/Desktop/PRISM/TMean')
...
```{r,eval=FALSE}
WB<-readOGR('G:\\My Drive\\HARP\\impoundment_evap_HARP-2016\\Shapefiles',layer='Waterbodies')
