...
C
C  Help Jing -1: want to write 'Main subroutine: AGWRC and KVARY are: ', AGWRC, KVARY
       AGWRC = -LOG(PWPM2(7))
C
...
C     + + + LOCAL VARIABLES + + +
      REAL       AINFLO
      DOUBLE PRECISION AGWOTEMP     ! TEMPORARY AGWO VARIABLE
C
C     + + + INTRINSICS + + +
      INTRINSIC  ABS
C
...
C
C  Help Jing - 2 (with minor correction): want to write: 'gwater: KGW, AGWS, KVARY: ', KGW, AGWS, KVARY
C
...
C          AGWO= KGW*AGWS
C          AGWO = (1.0-(1.0+KVARY*KGW*AGWS**KVARY)**(-1.0/KVARY))*AGWS
           AGWOTEMP = 1.0
           AGWOTEMP = AGWOTEMP + KVARY*KGW*AGWS**KVARY
           AGWOTEMP = AGWOTEMP**(-1.0/KVARY)
           AGWOTEMP = 1.0- AGWOTEMP
           AGWOTEMP = AGWOTEMP*AGWS
           AGWO = AGWOTEMP
        END IF
C      END IF
C END ICPRB change
...
C
C  Help Jing - 3:  want to write: 'AGWO, AGWS, AINFLW: ', AGWO, AGWS, AINFLW
C      PRINT*, 'AGWO, AGWS, AINFLO: ', AGWO, AGWS, AINFLO
C
      RETURN
      END
C
