...
C
C     + + + EXTERNALS + + +
      EXTERNAL     WMSGTT,OMSINI,DECCHX,INTCHR
C
C     + + + INPUT FORMATS + + +
 1000 FORMAT (7I5)
C
C     + + + OUTPUT FORMATS + + +
 ...
 2010 FORMAT (' ')
 2020 FORMAT (' * ',A80,' *')
 2040 FORMAT (' *  ERROR/WARNING ID:  ',2I4,51X,'  *')
 2050 FORMAT (' DATE/TIME: ',I4,'/',I2,'/',I2,' ',I2,':',I2)
 2060 FORMAT (' *',82X,'*')
C
C     + + + END SPECIFICATIONS + + +
      print*,messu,messfl,sclu,sgrp,count
C
      I0= 0
C
...
C                 have a real to write
                  DECP= -DECP
      print*,'3a4f2k2e'
      print*,RMSVL(RPOS),RLEN,SDIG,DECP,TBUF1(TPOS)
