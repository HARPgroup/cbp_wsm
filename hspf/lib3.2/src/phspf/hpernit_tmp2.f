...
c                  NICONC = factmg*NO3/pwmoistV ! MOISTM*1.0E6
           NICONC = factmg*( SMST /(fldcp))*NO3/pwmoistV ! MOISTM*1.0E6 
                KSINIKe=KSINIK !*SMST   /(fldcp) !effective mass max immobil
                immni = KSINIKe *NICONC/(NICONC+CSINI)
               else
                 NICONC = factmg*NO3/pwmoistV ! MOISTM*1.0E6
...
c               NICONC = factmg*NO3/pwmoistV   ! MOISTM*1.0E6
           NICONC = factmg*(SMST  /(fldcp))*NO3/pwmoistV  ! /MOISTM*1.0E6 
                ...
                IMMNI= IMMNI*pwmoistV / factmg  ! MOISTM/1.0E6 ! to pound
               else
                 NICONC = factmg*NO3/pwmoistV ! MOISTM*1.0E6
                 immni= KSINIK*NICONC / (NICONC + CSINI)/factk    ! mg/l
cnonon           IMMNI= IMMNI*pwmoistV/factmg ! MOISTM/1.0E6, to pound    
                 IMMNI= IMMNI*fldcpV  /factmg ! MOISTM/1.0E6, to pound     
               endif
332           continue  
chh          endif
c  ! pw end added   
...
c                  AMCONC = factmg*AMSU/pwmoistV ! MOISTM*1.0E6
           AMCONC = factmg*( SMST /(fldcp))*AMSU/pwmoistV ! MOISTM*1.0E6 
                KSIAMKe=KSIAMK !*SMST   /(fldcp) !effective mass max immobil
                immam = KSIAMKe *AMCONC/(AMCONC+CSIAM)
               else
                 AMCONC = factmg*AMSU/pwmoistV ! MOISTM*1.0E6
...
c               AMCONC = factmg*AMSU/pwmoistV   ! MOISTM*1.0E6
           AMCONC = factmg*(SMST  /(fldcp))*AMSU/pwmoistV  ! /MOISTM*1.0E6 
                ...
                IMMAM= IMMAM*pwmoistV / factmg  ! MOISTM/1.0E6 ! to pound
               else
                 AMCONC = factmg*AMSU/pwmoistV ! MOISTM*1.0E6
                 immam= KSIAMK*AMCONC / (AMCONC + CSIAM)/factk    ! mg/l
c                IMMAM= IMMAM*pwmoistV/factmg ! MOISTM/1.0E6, to pound    
                 IMMAM= IMMAM*fldcpV  /factmg ! MOISTM/1.0E6, to pound     
               endif
334           continue  
chh          endif
c  ! pw end added   
