#!/bin/csh
#sbatch --mail-type=BEGIN --mail-type=END --mail-user=gbhatt@chesapeakebay.net run_nps_and_ps_to_clm.csh b20_a2x_85_P lrseg 1990 1999
  if (${#argv} != 4 ) then
  ...
  echo $rscen $psmethod $hotstart | $tree/code/bin/p5_nps_and_ps_to_clm.exe
