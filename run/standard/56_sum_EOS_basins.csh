...
# set basins = (uMDB mMDB lMDB EshVA)
 set basins = (S P Y E R J W X watershed RIMP X_AFL X_BFL P_AFL P_BFL R_AFL R_BFL Y_AFL Y_BFL R_AFL R_BFL J_AFL J_BFL UpES MidES LowES VaES VAcapes)


 foreach basin ($basins)
   sbatch -pdebug summarize_EOS_output_aveann.csh $scen $basin $year1 $year2
 end
