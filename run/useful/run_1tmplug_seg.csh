...
#   GET SCENARIO, BASIN, and TREE
  ...
  if (${#argv} != 3) then
    if (${#argv} != 4) then
      echo ' '
      echo 'usage:  run_1tmplug_seg.csh scenario segment landuse'
      echo ' or     run_1tmplug_seg.csh scenario segment landuse tree'
      echo ' '
      exit
    endif
  endif
...
#    foreach lu ($perlnds $implnds)
      ...
      echo $seg, $lu, $scenario | $tree/code/bin/tmplug.exe
