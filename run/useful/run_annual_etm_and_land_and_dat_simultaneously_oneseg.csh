...
###############  the input years are only used for average annual output
  ...
  if (${#argv} != 5) then
    if (${#argv} != 4) then
      echo ' '
      echo 'usage:  run_annual_etm_and_land_and_dat_simultaneously_oneseg.csh scenario rseg aveyear1 aveyear2'
      echo ' or     run_annual_etm_and_land_and_dat_simultaneously_oneseg.csh scenario rseg aveyear1 aveyear2 tree'
      echo ' '
      exit
    endif
  endif
