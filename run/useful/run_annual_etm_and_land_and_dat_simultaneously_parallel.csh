...
###############  the input years are only used for average annual output
    ...
    if (${#argv} != 4) then
      echo ' '
      echo 'usage:  run_annual_etm_and_land_and_dat_simultaneously_parallel.csh scenario basin year1 year2'
      echo ' '
      exit
    endif
...
#    sbatch run_etm_and_land_and_dat_simultaneously_oneseg.csh $scenario $seg $year1 $year2
    sbatch run_annual_etm_and_land_and_dat_simultaneously_oneseg.csh $scenario $seg $year1 $year2
  end
