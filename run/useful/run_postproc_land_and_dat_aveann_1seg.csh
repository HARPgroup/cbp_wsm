...
#   GET SCENARIO, BASIN, and TREE
  ...
  if (${#argv} != 5) then
    if (${#argv} != 4) then
      echo ' '
      echo 'usage:  run_postproc_land_aveann.csh scenario river_seg aveyear1 aveyear2'
      echo ' or     run_postproc_land_aveann.csh scenario river_seg aveyear1 aveyear2 tree'
      echo ' '
      exit
    endif
  endif
