...
###############  the input years are only used for average annual output
    ...
    if (${#argv} != 4) then
      echo ' '
      echo 'usage:  run_postproc_land_and_dat_aveann_parallel.csh scenario basin year1 year2'
      echo ' '
      exit
    endif
  ...
  foreach seg ($segments)
    ...
    sbatch run_postproc_land_and_dat_aveann_1seg.csh $scenario $seg $year1 $year2
