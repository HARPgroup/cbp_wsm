...
#   GET SCENARIO, BASIN, and TREE
  ...
  if (${#argv} != 5) then
    if (${#argv} != 6) then
      echo ' '
      echo 'usage:  run_postproc_otherDF.csh scenario DFscen rseg aveyear1 aveyear2'
      echo ' or     run_postproc_otherDF.csh scenario DFscen rseg aveyear1 aveyear2 tree'
      echo ' '
      exit
    endif
  endif
