...
#   GET SCENARIO, BASIN, and TREE
  ...
  if (${#argv} != 6) then
    if (${#argv} != 7) then
      echo ' '
      echo 'usage:  run_postproc_river_stats_oneseg.csh scenario calscen segment module year1 year2 '
      echo ' or     run_postproc_river_stats_oneseg.csh scenario calscen segment module year1 year2 tree '
      echo ' '
      exit
    endif
  endif
