...
#  cd $tree/tmp/scratch/temp$$/
  ...
  if ( $year1 <= 2000 && $year2 <= 2000 ) then
     echo $rscen $hotstart $Request $year1 $year2 $CH3D | $tree/code/bin/p5_sho_to_request_y1y2_P6_RPA_RIB_PSMETHOD_8401.exe
  else if ( $year1 > 2000 && $year2 > 2000 ) then
     echo $rscen $hotstart $Request $year1 $year2 $CH3D | $tree/code/bin/p5_sho_to_request_y1y2_P6_RPA_RIB_PSMETHOD_9514.exe
  else
