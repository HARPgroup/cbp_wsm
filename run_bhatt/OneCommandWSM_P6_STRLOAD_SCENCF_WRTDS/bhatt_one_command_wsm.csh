...
if ($RUN_POSTPROC == 1) then
     ...
     if( $CDF == 0 ) then
          ...
          foreach segment ( $segments )
               ...
               srun --nodes=1 --ntasks=1 --exclusive --job-name=`printf "%03d" $i`_$iSLURM_JOB_NAME bhatt_run_postproc_river_daily_oneseg.csh  $scenario $segment $year1 $year2 $user-$iSLURM_JOBID-`printf "%04d" $i` &
     ...
     mv ../../output/river/daily/${scenario} ../../output/river/daily/WRTDS_${scenario}
     mkdir ../../output/river/daily/${scenario}
