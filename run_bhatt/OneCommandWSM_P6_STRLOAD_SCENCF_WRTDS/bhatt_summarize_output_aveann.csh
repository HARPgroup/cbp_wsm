...
#echo $OMP_NUM_THREADS
  ...
  echo "... running sumout_aveann_P6.exe"
  echo $scenario $basin $year1 $year2 $EOF $EOS $DEL | $tree/code/bin/sumout_aveann_P6.exe
      if (-e problem) then
        echo ' '
        cat problem
        exit
  ...
  echo "... running sum_delivery_factor.exe"
  ...
  echo "... running copy_ps_loads.exe"
