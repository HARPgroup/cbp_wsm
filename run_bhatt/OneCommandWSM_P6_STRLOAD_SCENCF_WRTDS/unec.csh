...
#*** RUN UNEC SIMULATION
  ...
  #echo $seg $scenario $spin_mons 1984 2014 $target 1985 2014 $WDM $DEBUG0 | ../../../code/bin/unec.exe
  #echo $seg $scenario $spin_mons 1984 2014 1991 2000 $WDM $DEBUG0 | ../../../code/bin/unec.exe
  #echo $seg $scenario $spin_mons 1984 2014 $WDM $DEBUG0 | ../../../code/bin/unec.exe
  echo $seg $scenario $spin_mons $WDM $DEBUG0 | ../../../code/bin/unec.exe
