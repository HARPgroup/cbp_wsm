...
####### FIND EOF, EOS, AND EOSWDM
     ...
     echo $scenario $seg $loud $ETM $EOFdaily $EOFmonthly $EOFannual $EOFaveann $EOSdaily $EOSmonthly $EOSannual $EOSaveann $AVEYEAR1 $AVEYEAR2 $lu | $tree/code/bin/etm_and_postproc_P6_StrLoad_BBFL.exe
...
#  end
  ...
  echo "FINISHETMLOG $seg"

  #echo "FINISH" > ../../../output/etm/$scenario/_${seg}.csv
