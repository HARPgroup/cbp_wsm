...
************************************************************************
      ...
      parameter (year1=1990,month1=1,day1=1)
      parameter (year2=1999,month2=12,day2=31)
...
********** END OF SETUP, OPEN FILE AND LOOP OVER CELLS
      fnam = '../link/harry_wang_flows.prn'
     ...
     O              pairq)  ! get the data
      ...
      fnam = 'harrys_flows.prn'
      fnam = '../out/harry/'//rscen(:lenrscen)//'/'//fnam
      open(dfile,file=fnam,status='unknown',iostat=err)
      if (err.ne.0) go to 991
      write(dfile,'(a10,12(i4,a1))') 
     .        'year,day,',(cells(nc),',',nc=1,ncells)
      do ny = year1,year2
        do nd = 1,ndaysinyear(ny)
          write(dfile,'(i4,a1,i3,12(a1,f10.2))') 
