...
c no! er   pwwiltpt = wiltpt  * cfinma    ! for forest only
         ...
         pwmoistV=pwmoistd*1000.*1233./12.   ! water: in-arce -> volume L 
         factmg=1000000./2.2046              ! pound to mg
         fldcpV=fldcp*1000.*1233./12.   ! fldcp water: in-arce -> volume L 
         fldcpW=fldcpV*2.2046           ! fldcp water weight: pound
