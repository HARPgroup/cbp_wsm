...
cif         NICONC = (  SMST  /(fldcp))*NO3/MOISTM*1.0E6 
                ...
                utni = utni * pwmoistV / factmg   ! to pound 
cff           UTNI= UTNI*MOISTM/1.0E6      ! out this getting more uptake 
               else
              NICONC = factmg*NO3/pwmoistV ! MOISTM*1.0E6
cif           NICONC =                    NO3/MOISTM*1.0E6 
                 utni = KSUNIK*NICONC/(NICONC + CSUNI)/factk  ! mg/l 
              utni = utni * fldcpV / factmg  ! to pound if M-M is mg/l
cif           UTNI = UTNI*fldcpW/1.0E6 
               endif 
442            continue 
             endif
c  ! pw end added 
