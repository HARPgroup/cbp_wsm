...
************************************************************************
      ...
      character(16):: date(ndaymax*24),pltvalue(ndaymax*24)   ! reading variables
...
993   report(1) = 'too many values in file'
      report(2) = fnam
      report(3) = './pp/src/postproc/river/stats/plt2cal.f'
      go to 999
