...
***********  scenarios, useful for running geographic isolation runs
      real LRsegRiverFactor(maxlrsegs,0:maxBvar) ! extra column for scratch
      real RsegRiverFactor(maxrsegs,0:maxBvar)! extra column for scratch
************** 
      character*13 LRsegRsegs(maxlrsegs)  ! rseg portion of lrsegs
...
******** get River Factor for each lrseg
      ...
      call getRiverFactor(
     I                    modscen,LRsegRsegs,maxlrsegs,nlrsegs,
     I                    nBvar,Bname,
...
******** get River Factor for each rseg
      ...
      call getRiverFactor(
     I                    modscen,rsegs,maxrsegs,nrsegs,nBvar,Bname,
